...
We compare six estimators—CF, SO_ANN, DO_ANN, NO_ANN, SO_RF, and NO_RF—over 500 Monte-Carlo replications and five training sizes (1, 3, 5, 10 and 20 fields). Each replication contains 1,440 evaluation units. Accuracy is assessed by the RMSE of the estimated economically optimal nitrogen rate (EONR) with respect to the true (simulated) EONR. Figures 1–4 summarize errors; Figure 5 panels illustrate representative yield–N response functions that help interpret the error patterns.

...
MODEL_DIRS <- c(
  ...
  "Simple_ANN_outcome_one_field","Simple_ANN_outcome_two_fields","Simple_ANN_outcome_three_fields", "Simple_ANN_outcome_four_fields",
  "Simple_ANN_outcome_five_fields","Simple_ANN_outcome_ten_fields","Simple_ANN_outcome_twenty_fields",
  "NO_RF_one_field","NO_RF_five_fields","NO_RF_ten_fields",
  "HalfRRF_one_field","HalfRRF_five_fields","HalfRRF_ten_fields",
  "half_RANN_outcome_one_field","half_RANN_outcome_five_fields","half_RANN_outcome_ten_fields", "half_RANN_outcome_twenty_fields"
)
...
parse_n_fields <- function(folder) {
  case_when(
    ...
    str_detect(folder, "(?:_2_fields|two_fields?)\\b")    ~ 2L,
    str_detect(folder, "(?:_3_fields|three_fields?)\\b")  ~ 3L,
    str_detect(folder, "(?:_4_fields|four_fields?)\\b")   ~ 4L,
    str_detect(folder, "(?:_5_fields|five_fields?)\\b")   ~ 5L,
    str_detect(folder, "(?:_10_fields|ten_fields?)\\b")   ~ 10L,
    str_detect(folder, "(?:_20_fields|twenty_fields?)\\b")~ 20L,
    TRUE ~ NA_integer_
  )
}
...
rmse_df <- rmse_tbl_raw %>%
  ...
  dplyr::mutate(
    ...
    field_f = factor(`#field`, levels = c(1, 2, 3, 4, 5, 10, 20),
                     labels = c("1 field", "2 fields", "3 fields", "4 fields",  "5 fields", "10 fields", "20 fields"))
  )

...
g_td <- readRDS(here::here("writing/Figures/g_td.rds"))
```
...
# ggsave(
#   filename = here::here("Proposal_presentation/fig_rmse_hist.png"),
#   plot = p,
#   width = 12,
#   height = 7,
#   bg = "white"
...
# ggsave(here::here("Proposal_presentation","model_improvement.png"), p_mean, width = 9, height = 5, dpi = 300)
```
...
::: {.column-margin}
<span style = "color: blue;"> All this is probably redundant. What are you adding beyond the previous paragraphs? </span>
:::
<!--end of column-margin-->
...
<span style = "color: blue;"> I do not see the purpose of this much. Contrast CF, SO-NN, and the worst (all in the same panel) across the number of fields. </span>

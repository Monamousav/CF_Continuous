...
::: {.column-margin}
Right now, it is written as if prediction-oriented and causal ML have been used in parallel. But, @kakimoto2022causal is in response to the danger of applying simply applying prediction-oriented ML approaches. Modify the text to reflect that here. Cite [this](https://link.springer.com/article/10.1007/s11119-024-10136-x) to motivate the use of causal ML.
:::
...
::: {.column-margin}
<span style = "color: blue;"> We need to emphasize that we are proposing approaches that have not been tried anywhere: SO-NN and semi-parametric-CF. They are the main approaches. We then have other contrasting approaches to compare against. </span>
:::
<!--end of column-margin-->  
...
::: {.column-margin}
<span style = "color: blue;"> SO-ANN not introduced yet. You need to talk more about what you do in the above paragraph (mostly SO-NN and semi-parametric CF). </span>
:::
<!--end of column-margin-->
...
::: {.column-margin}
<span style = "color: blue;"> Explain in  more detail about why it this is innovative. Explain the concept of linearization with splines using the figure I generated in my old manuscript. </span>
:::
<!--end of column-margin-->
...
<span style = "color: red;"> Add profit differential as the measure. Discuss them in the results as well. </span>
